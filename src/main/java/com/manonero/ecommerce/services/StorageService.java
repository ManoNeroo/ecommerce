...
import com.manonero.ecommerce.models.StorageException;
...
public class StorageService implements IStorageService {
	...
	public String store(MultipartFile file) {
		try {
			...
			String fileName = AppUtils.generateRandomString(15) + file.getOriginalFilename();
			...
			return "/" + storageProperties.getLocation() + "/" + fileName;
		} catch (IOException e) {
